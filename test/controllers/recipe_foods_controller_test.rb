...
class RecipeFoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipe_food" do
    assert_difference("RecipeFood.count") do
      post recipe_foods_url, params: { recipe_food: { foods_id: @recipe_food.foods_id, quantity: @recipe_food.quantity, recipes_id: @recipe_food.recipes_id } }
    end
  ...
  test "should update recipe_food" do
    patch recipe_food_url(@recipe_food), params: { recipe_food: { foods_id: @recipe_food.foods_id, quantity: @recipe_food.quantity, recipes_id: @recipe_food.recipes_id } }
