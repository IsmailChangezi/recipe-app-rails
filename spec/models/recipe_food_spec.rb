...
RSpec.describe RecipeFood, type: :model do
  ...
  recipe = Recipe.new(name: 'potato',  preparation_time: "20 munites", cooking_time: "10 munites",description: 'Potato is a popular mail in the world', users: user1)
  recipe_food = RecipeFood.new(quantity: 13, foods: food, recipes: recipe) 
